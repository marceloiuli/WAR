...
![alt text](https:// "Updated Score On Board")
...
![alt text](https:// "Updated Message For Each Round")
...
![alt text](https:// "Winning Message Displayed Between Boards")
...
![alt text](https:// "Screenshot Of Reset Button")

#### Next Steps:

* I'd like to add button guards to put more use to the code I've wrote to clear the board when clicking the played cards, and when the game is over the only clickable area would be the reset button.

* I'd also like to fix the size of the board when in a full screen window so it's not as stretched out.
